...
<html lang="en">
  ...
  <p>
    <center>  
    <img src="ya-removebg-preview.png" style="width: 200px;border-radius: 20px;" />
    </center>  
...
<?php
                    ...
                    if (isset($_POST['proses'])) {
                        ...
                        class Tampil{
                            public function struk($no2, $nama2, $unit_p2, $tanggal_g2, $jabatan2, $lamakerja2, $status2, $bpjs2, $pinjaman2, $cicilan2, $infaq2, $gaji2, $bonus2, $gajiBersih2){
                            ...
                            $cetak = new Tampil();
                             ...
                             echo $cetak->struk($no, $nama, $unit_p, $tanggal_g, $jabatan, $lamakerja, $status, $bpjs, $pinjaman, $cicilan, $infaq, $gaji, $bonus, $gajiBersih);
                        }
                ?>
                </div>
</div>
